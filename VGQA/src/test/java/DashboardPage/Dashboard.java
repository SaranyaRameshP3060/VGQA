...
public class Dashboard {
  ...
  public void f(){
	  ...
	  /*
	  driver.findElement(By.xpath("//button[@class=\"glintButton btnLink hideForExport\"]")).click();
	  ...
	  System.out.println("Entering to javascript executor");
	  WebElement down = driver.findElement(By.xpath("//button[contains(text(),'Learn more')]"));
  ...
  public void exportToPPT() {
	  Actions a=new Actions(driver);
	  driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5000));
	  a.moveToElement(driver.findElement(By.xpath("//span[contains(text(),'Export Report to PowerPoint')]"))).click().perform();
	  System.out.println("Export to PPT");
